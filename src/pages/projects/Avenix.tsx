    ...
    <div className="min-h-screen relative">
      ...
      <section className="relative py-16 px-6">
        <div className="container mx-auto max-w-5xl flex flex-col items-center">
          <div className="glass-card rounded-2xl sm:px-4 p-12 text-center space-y-6 bg-gradient-to-br from-primary via-card/80 to-primary border-accent/30 hover:border-accent/50 transition-all group">
